        ...
        <div class="content-area">
            ...
            <?php if ($role['is_system'] == 1): ?>
                <div class="alert alert-warning">
                    <strong>⚠️ Rol del Sistema:</strong> Este es un rol del sistema. Solo puede modificar sus permisos, no su nombre ni descripción.
                </div>
            <?php endif; ?>
                    ...
                    <form action="<?= base_url('roles/update/' . $role['id']) ?>" method="post">
                        ...
                        <div class="form-group" style="margin-bottom: 1.5rem;">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      rows="3" 
                                      maxlength="500"
                                      <?= $role['is_system'] == 1 ? 'readonly' : '' ?>><?= old('description', $role['description']) ?></textarea>
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($modules as $moduleKey => $moduleName): ?>
                                        <?php 
                                        $modPerms = $permissions[$moduleKey] ?? ['view' => 'N', 'insert' => 'N', 'update' => 'N', 'delete' => 'N'];
                                        ?>
                                        <tr>
