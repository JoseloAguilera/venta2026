<aside class="sidebar">
    ...
    <div class="sidebar-header">
        ...
        ?>
        <div class="sidebar-logo">🚀 <?= esc($companyName) ?></div>
    </div>
        ...
        <div class="nav-section">
            ...
            <?php if (can_view('sales')): ?>
                <a href="<?= base_url('sales') ?>"
                    class="nav-link <?= strpos(uri_string(), 'sales') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">💰</span>
                    <span>Ventas</span>
                </a>
            <?php endif; ?>
            ...
            <?php if (can_view('purchases')): ?>
                <a href="<?= base_url('purchases') ?>"
                    class="nav-link <?= strpos(uri_string(), 'purchases') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">🛒</span>
                    <span>Compras</span>
                </a>
            <?php endif; ?>
        ...
        <div class="nav-section">
            ...
            <?php if (can_view('categories')): ?>
                <a href="<?= base_url('categories') ?>"
                    class="nav-link <?= strpos(uri_string(), 'categories') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">📁</span>
            ...
            <?php if (can_view('products')): ?>
                <a href="<?= base_url('products') ?>"
                    class=" nav-link <?= strpos(uri_string(), 'products') !== false && strpos(uri_string(), 'product-stock') === false ? 'active' : '' ?>">
                    <span class="nav-icon">📦</span>
                    <span>Productos</span>
                </a>
            <?php endif; ?>
            ...
            <?php if (can_view('warehouses')): ?>
                <a href="<?= base_url('warehouses') ?>"
                    class="nav-link <?= strpos(uri_string(), 'warehouses') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">🏭</span>
                    <span>Depósitos</span>
                </a>
            <?php endif; ?>
            ...
            <?php if (can_view('product_stock')): ?>
                <a href="<?= base_url('product-stock') ?>"
                    class="nav-link <?= strpos(uri_string(), 'product-stock') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">📊</span>
            ...
            <?php if (can_view('inventory_adjustments')): ?>
                <a href="<?= base_url('inventory-adjustments') ?>"
                    class="nav-link <?= strpos(uri_string(), 'inventory-adjustments') !== false ? 'active' : '' ?>">
            ...
            <?php if (can_view('inventory_transfers')): ?>
                <a href="<?= base_url('inventory-transfers') ?>"
                    class="nav-link <?= strpos(uri_string(), 'inventory-transfers') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">🚚</span>
        ...
        <div class="nav-section">
            ...
            <?php if (can_view('customers')): ?>
                <a href="<?= base_url('customers') ?>"
                    class="nav-link <?= strpos(uri_string(), 'customers') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">👥</span>
                    <span>Clientes</span>
                </a>
            <?php endif; ?>
            ...
            <?php if (can_view('suppliers')): ?>
                <a href="<?= base_url('suppliers') ?>"
                    class="nav-link <?= strpos(uri_string(), 'suppliers') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">🏢</span>
        ...
        <div class="nav-section">
            ...
            <?php if (can_view('payments')): ?>
                <a href="<?= base_url('payments') ?>"
                    class="nav-link <?= strpos(uri_string(), 'payments') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">💳</span>
                    <span>Pagos</span>
                </a>
            <?php endif; ?>
            ...
            <?php if (can_view('expenses')): ?>
                <a href="<?= base_url('expenses') ?>"
                    class="nav-link <?= strpos(uri_string(), 'expenses') !== false ? 'active' : '' ?>">
                    <span class="nav-icon">💸</span>
                    <span>Gastos</span>
                </a>
            <?php endif; ?>
            ...
            <div class="nav-section">
                ...
                <?php if (can_view('settings')): ?>
                    <a href="<?= base_url('settings') ?>"
                        class="nav-link <?= strpos(uri_string(), 'settings') !== false ? 'active' : '' ?>">
                        <span class="nav-icon">⚙️</span>
                ...
                <?php if (can_view('roles')): ?>
                    <a href="<?= base_url('roles') ?>"
                        class="nav-link <?= strpos(uri_string(), 'roles') !== false ? 'active' : '' ?>">
                        <span class="nav-icon">🔐</span>
                        <span>Roles</span>
                    </a>
                <?php endif; ?>
