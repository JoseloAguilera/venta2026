                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('warehouses/update/' . $warehouse['id']) ?>" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3"><?= old('description', $warehouse['description']) ?></textarea>
                                </div>

                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="is_active" name="is_active" <?= old('is_active', $warehouse['is_active']) ? 'checked' : '' ?>>
