                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('customers/update/' . $customer['id']) ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="<?= old('name', $customer['name']) ?>" required autofocus>
                        </div>

                        <div class="form-group">
                            <label for="document" class="form-label">Documento</label>
                            <input type="text" id="document" name="document" class="form-control" value="<?= old('document', $customer['document']) ?>">
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?= base_url('customers') ?>" class="btn btn-secondary">❌ Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
